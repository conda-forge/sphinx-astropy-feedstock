...
All platforms: [![Circle CI](https://circleci.com/gh/conda-forge/sphinx-astropy-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/sphinx-astropy-feedstock)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/sphinx-astropy/badges/version.svg)](https://anaconda.org/conda-forge/sphinx-astropy)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/sphinx-astropy/badges/downloads.svg)](https://anaconda.org/conda-forge/sphinx-astropy)
...
Once the `conda-forge` channel has been enabled, `sphinx-astropy` can be installed with:

```
conda install sphinx-astropy
```

It is possible to list all of the versions of `sphinx-astropy` available on your platform with:
